...
Geocode.setApiKey("AIzaSyAXqG-Gj13lWS2mNilDjVGw807lMJs55mM");
...
const Dashboard = (props) => {
  ...
  useEffect(function effectFunction() {
    Geocode.fromAddress(props.source).then(
      (response) => {
  ...
  useEffect(() => {
    ...
    const mark1 =localStorage.getItem("loggedinUser")=="admin"?null:<Marker position={{ lat: srclat, lng: srclng}} />
    const mark2 =localStorage.getItem("loggedinUser")=="admin"?null:<Marker position={{lat: destlat, lng: destlng }}/>
    ...
    return (
        ...
        >
          {mark1}
          {mark2}
        {/* <Polyline path={[{ lat: 42.3601, lng: -71.0589 }, { lat: 42.2529, lng: -71.0023 }]}/> */}
        </Map>
    );
  }

export default GoogleApiWrapper({
  apiKey: 'AIzaSyAXqG-Gj13lWS2mNilDjVGw807lMJs55mM'
})(Dashboard);